        ...
        if (typeof (data) === 'object' && data.length > 0) {
            ...
            $.each(data, function (i, el) {
                ...
                $("#tblcliente tbody").append('<tr><td>' + el.Dni + '</td><td>' +
                    ...
                    '<td><span onclick="GetAdd(' + el.IdPersona + ')" style="cursor:pointer">Add</span></td>' +
                    '</tr>'
                );
            });
        }
            ...
            if (typeof (data) === 'object' && data.length > 0) {
                ...
                $.each(data, function (i, el) {
                    ...
                    $("#tblpaciente tbody").append('<tr><td>' + el.Nombre + '</td><td>' +
                        ...
                        el.Edad + '</td>' +
                        estato + '<td><span onclick="EditPaciente(' + el.IdPaciente + ')" style="cursor:pointer">Editar</span></td>' +
                        '</tr>'
                    );
                });
            }
